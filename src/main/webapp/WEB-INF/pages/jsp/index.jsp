		...
		<div class="jumbotron">
		 ...
		 <div class="container">
            ...
            <div class="col-xs-6 col-lg-4 text-center">
              ...
              <a href="<c:url value='/ControlServlet?task=deconnexion' />">
